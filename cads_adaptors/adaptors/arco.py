...
DEFAULT_BASE_URL = "https://s3.cds.ecmwf.int/swift/v1/AUTH_cf0252abd9434b5e859bc07c159ec2f4"
...
class ArcoCdsAdaptor(cds.AbstractCdsAdaptor):
    def retrieve(self, request: Request) -> BinaryIO:
        ...
        BUCKET = self.config.get('BUCKET', 'cadl-arco-geo/arco/era5/sfc/geoChunked.zarr')

        arco_ds = xr.open_zarr(os.join(BASEURL, BUCKET))
