...
def test_no_area():
    ...
    # With config
    config = {"snap_area": {"grid": {"delta_lon": 0.1, "delta_lat": 0.1}}}
...
def test_general():
    ...
    # All round down
    _exec("10.123/-20.345/-30.456/40.789", config, ["10.1", "-20.3", "-30.4", "40.7"])

    # N/W round up, E/W round down
    _exec("-10.123/20.345/-30.456/40.789", config, ["-10.2", "20.4", "-30.4", "40.7"])

    # N/W round down, E/W round up
    _exec("80.123/-120.345/30.456/-40.789", config, ["80.1", "-120.3", "30.5", "-40.8"])
...
def test_general_with_offset():
    ...
    config = {
        "snap_area": {
            "grid": {"delta_lon": 0.1, "delta_lat": 0.2, "lon0": 0.05, "lat0": 0.1}
        }
    }

    # All round down
    _exec("10.123/-20.345/-30.456/40.789", config, ["10.1", "-20.25", "-30.3", "40.75"])

    # N/W round up, E/W round down
    _exec("-10.123/20.345/-30.456/40.789", config, ["-10.3", "20.35", "-30.3", "40.75"])
