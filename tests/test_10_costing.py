...
def test_estimate_precise_size_basic() -> None:
    ...
    assert (
        costing.estimate_precise_size(
            form,
            [{"param": {"Z"}, "time": {"12:00", "00:00"}, "level": {"500"}}]
        )
        == 2
    )
